...
let projects = [
  {
    id: 1,
    name: 'Personal Blog Redesign',
    description: 'Redesign and relaunch my personal blog with a fresh look.',
    created_at: seededAt,
    updated_at: seededAt,
  },
  {
    ...
    description: 'Build a command-line app that fetches and displays weather data.',
    created_at: seededAt,
    updated_at: seededAt,
  },
]
